...
Save = Аралаш
Remove = Кораҥдаш
Confirm removal = Кораҥдымашым кумылаҥаш
Human code = Тергымашын код

Management = Виктарымаш
Password = Шолыпмут
keep authorization = шарнаш
Enter = Пураш

Comments = Комментарий-влак


Start = Тӱҥалтыш
Website name = Сайтын лӱм
Admin password = Администраторын шолыпмут
Go = Тӱҥалаш
...
Favourite = Пыштыме палем
in favourites = пыштыме палыш ешараш
...
Remind password = Шолыпмутым монден улыда
Your email: = Тыйын e-mail:
Email = E-mail
